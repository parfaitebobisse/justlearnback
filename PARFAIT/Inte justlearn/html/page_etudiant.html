    ...
    <div class="wrapper">
        ...
        <nav id="sidebar">
            ...
            <ul class="list-unstyled components" id="liste_menu_respo_dash">
                <li class="active">
                    <a href="#homeSubmenu" data-toggle="collapse" aria-expanded="false" class="lien_navigation_dashbord active">
                ...
                <li>
                    <a href="#" class="lien_navigation_dashbord">
                        <div class="container_texte">
                            <span class="titre_cours">GL3 - RSE</span>
                            <span>Sceance dans 
                                <span class="statu_cours">en cours...</span>
            ...
            <div class="sous_bloc_haut">
                <span class="bouton_requete"><i class="fas fa-sticky-note"></i> Requête</span>
            ...
            <div class="dropdown">
                <div id="bloc_espace_404">
                    ...
                    <div class="dropdown-menu animate slideIn" aria-labelledby="photo_profil" id="dropdown_header">
                        <a class="dropdown-item bouton_requete" href="#">
